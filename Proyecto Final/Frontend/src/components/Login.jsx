...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('http://saf1.35.192.41.172.nip.io/pythonm1/auth/login', {
        email,
        contrasena: password,
      });
      ...
      if (response.data.access_token) {
        ...
        const profileResponse = await axios.get('http://saf1.35.192.41.172.nip.io/pythonm1/auth/profile', {

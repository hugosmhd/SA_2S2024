...
export const ModalAddProduct = ({ onNewProduct }) => {
    ...
    useEffect(() => {
        const fetchCategories = async () => {
          try {
            const response = await axios.get('http://saf1.35.192.41.172.nip.io/gom2/api/categories');
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post("http://saf1.35.192.41.172.nip.io/gom2/api/products", 
                formData, {
                    headers: {

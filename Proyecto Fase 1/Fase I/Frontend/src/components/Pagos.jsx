...
export const Pagos = () => {
    ...
    const fetchTarjetas = () => {
        axios
        .get(`http://saf1.${apiUrl}.nip.io/nodem4/api/tarjetas`,{
            headers: {
        ...
        axios
        .get(`http://saf1.${apiUrl}.nip.io/nodem4/api/cartera`, {
            headers: {
                'Authorization': `Bearer ${token}`  // Agregar el token en el encabezado Authorization
            }
        })
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post(`http://saf1.${apiUrl}.nip.io/nodem4/api/tarjetas`, formData, {
                headers: {
                    'Authorization': `Bearer ${token}`  // Agregar el token en el encabezado Authorization
                }
            });
    ...
    const handleSubmitDeleteTarjeta = async (e) => {
        ...
        try {
            ...
            const response = await axios.delete(`http://saf1.${apiUrl}.nip.io/nodem4/api/tarjetas/`+idTarjeta);
    ...
    const handleSubmitRecargar = async (e) => {
        ...
        console.log('Formulario enviado:', formData);
        try {
            const response = await axios.put(`http://saf1.${apiUrl}.nip.io/nodem4/api/cartera`, formData, {
                headers: {
                    'Authorization': `Bearer ${token}`  // Agregar el token en el encabezado Authorization
                }
            });
